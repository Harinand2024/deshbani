...
# home-pahe---------
def home(request):
    # seo=seo_optimization.objects.get(pageslug='https://www.deshbani.com/')
    seo = seo_optimization.objects.filter(pageslug='https://www.deshbani.com/').first()
...
def AllvideoNews(request, slug):
    ...
    if not seo:
        ...
        seo = {
            ...
            "meta_description": "Latest video news from Deshbaani News",
...
def SubscribeView(request):
    if request.method == "POST":
        ...
        try:
            ...
            message = f"""
            Subject: Welcome to deshbaani News - Your Source for Insightful News!
            Dear {fname},
            Thank you for subscribing to deshbaani News! Stay updated with the latest news.
                Regards,
                deshbaani News
            """
            send_mail(
                "Welcome to deshbaani News",
                message,
...
def send_otp(request):
    if request.method == "POST":
        ...
        send_mail(
            "Your Secure OTP for deshbaani News",
