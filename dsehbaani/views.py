...
def SubscribeView(request):
    if request.method == "POST":
        ...
        try:
            ...
            message = f"""
            Subject: Welcome to Dsehbaani News - Your Source for Insightful News!
            Dear {fname},
            Thank you for subscribing to Dsehbaani News! Stay updated with the latest news.
                Regards,
                Dsehbaani News
            """
            send_mail(
                "Welcome to Dsehbaani News",
                message,
...
def send_otp(request):
    if request.method == "POST":
        ...
        send_mail(
            "Your Secure OTP for Dsehbaani News",
