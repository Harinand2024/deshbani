...
def custom_sitemap_index(request):
    ...
    sitemaps = [
        {'loc': 'https://www.deshbaani.com/sitemap/news', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/videos', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/articles', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/images', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/archive', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/tags', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/static', 'lastmod': now},
        {'loc': 'https://www.deshbaani.com/sitemap/categories', 'lastmod': now},
    ]
...
def sitemap_news(request):
    ...
    for item in news_items:
        try:
            ...
            'loc': f"https://www.deshbaani.com{url}",
...
def sitemap_images(request):
    ...
    sitemap_list = [{'loc': f"https://www.deshbaani.com/sitemap/images/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_images_by_month(request, year, month):
    ...
    sitemap_entries = [
        {
            'loc': f"https://www.deshbaani.com{post.get_absolute_url()}",
            'image': f"https://www.deshbaani.com{post.post_image.url}",
...
def sitemap_videos(request):
    ...
    sitemap_list = [{'loc': f"https://www.deshbaani.com/sitemap/videos/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
    ...
    sitemap_entries = [
        {
            ...
            'thumbnail': f"https://www.deshbaani.com{post.video_thumbnail.url}" if post.video_thumbnail else "",
            'lastmod': post.updated_at.strftime('%Y-%m-%dT%H:%M:%SZ'),
...
def sitemap_article(request):
    ...
    sitemap_list = [{'loc': f"https://www.deshbaani.com/sitemap/articles/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_archive(request):
    ...
    sitemap_list = [{'loc': f"https://www.deshbaani.com/sitemap/archive/{key}", 'lastmod': value} for key, value in sitemap_entries.items()]
...
def sitemap_tags(request):
    ...
    for tag in tags:
        ...
        urls.append({
            'loc': f"https://www.deshbaani.com{tag.get_absolute_url()}",
...
def sitemap_static(request):
    ...
    for name in static_names:
        try:
            loc = f"https://www.deshbaani.com{reverse(name)}"
        except Exception:
            continue
        urls.append({
            'loc': loc,
...
def sitemap_categories(request):
    ...
    for cat in cats:
        ...
        urls.append({
            'loc': f"https://www.deshbaani.com/all-news/{cat.cat_slug}",
        ...
        for sub in subs:
            ...
            urls.append({
                'loc': f"https://www.deshbaani.com/{cat.cat_slug}/{sub.subcat_slug}",
